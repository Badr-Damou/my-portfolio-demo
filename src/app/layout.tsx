...
const title = 'Badr Damou | Full-Stack Web Developer in Casablanca'
...
export const metadata: Metadata = {
  ...
  description,
  category: 'technology',
  // Removed metadataBase + alternates since no backend or env vars are needed
  openGraph: {
    title,
    description,
    siteName: 'Badr Damou Portfolio',
    type: 'website',
  },
  twitter: {
    title,
